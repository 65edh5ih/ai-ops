...
| `.github/workflows/codex-review-inbox.yml` | （信号）cron（毎時）＋手動で上記を実行し、全体一覧を private の `.ops-sync/codex-review-inbox-all.md`、各リポジトリの自分の分を `.ops-sync/codex-review-inbox.md` へ push（変化があるときだけ） |
